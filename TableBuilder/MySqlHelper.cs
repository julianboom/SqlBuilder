...
namespace Helpers
{
    ...
    public sealed partial class MySqlHelper
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        public string ConnectionString = ConfigurationManager.ConnectionStrings["Mysql"].ToString();
        ...
        public DataTable ExecuteDataTable(string commandText, params MySqlParameter[] parms)
        {
            ...
            a = ExecuteDataTable(ConnectionString, CommandType.Text, commandText, parms);
            return a;
        ...
        {
            DataTable a = ExecuteDataSet(connectionString, commandType, commandText, parms).Tables[0];
            return a;
            //return ExecuteDataSet(connectionString, commandType, commandText, parms).Tables[0];
        }
